...
*/		
	...
	//要更新的資料 updateTransaction(Statement smUpdate, int 股票代碼, int 買進或作空, int 找到要買進或作空的時間, int 找到要賣出或回補的時間, boolean 是否17點之後)
	...
	public static void main(String[] args) {
		...
		int stockId ;			 // 股票代碼
		int cate = 0;			 // 種類 (買進或作空) 11 ->買進  21->作空
